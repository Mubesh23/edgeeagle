...
strict, bounded metadata codec are implemented; snapshot verification/storage
remain pending. Its `REPLAY_ONLY` restriction preserves unknown availability and
